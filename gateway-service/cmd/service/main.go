...
import (
	"context"
	"fmt"
	"gateway-service/gateway-service/db/postgres/connection"
	"gateway-service/gateway-service/internal/application/adapter/api/http/create_user_handler"
	"gateway-service/gateway-service/internal/application/adapter/api/http/delete_user_handler"
	"gateway-service/gateway-service/internal/application/adapter/api/http/fetch_user_handler"
	"gateway-service/gateway-service/internal/application/adapter/api/http/login_handler"
	"gateway-service/gateway-service/internal/application/adapter/api/routes"
	"gateway-service/gateway-service/internal/application/helper/logging"
	"gateway-service/gateway-service/internal/application/repository"
	"gateway-service/gateway-service/internal/application/service/create_user_service"
	"gateway-service/gateway-service/internal/application/service/delete_user_service"
	"gateway-service/gateway-service/internal/application/service/fetch_user_service"
	"gateway-service/gateway-service/internal/application/service/login_service"
	"log"
	"net/http"
	"os"
	"os/signal"
